...
const Filter = ({ onFilterChange, cityUrl }) => {
  ...
  const businessTypes = [
    { label: 'Restaurant for Sale', value: 'restaurant', path: 'restaurant-for-sale' },
    { label: 'Convenience Store for Sale', value: 'convenience-store', path: 'convenience-store-for-sale' },
    { label: 'Office for Lease', value: 'office', path: 'offices-for-lease' }
  ];

  const priceRanges = [
    { label: '$0 - 500k', value: '0-500000', min: 0, max: 500000 },
    { label: '$500k - $999k', value: '500000-999000', min: 500000, max: 999000 },
    { label: '1mil - 1.5mil', value: '1000000-1500000', min: 1000000, max: 1500000 }
  ];
  ...
  const handleFilterChange = async (type, value) => {
    if (type === 'business') {
      ...
      try {
        ...
        const selectedRange = priceRanges.find(range => range.value === newPriceRange);
    ...
    <div className="flex flex-wrap items-center gap-4 mb-8">
      <div className="relative w-48">
        ...
        <div className="absolute right-3 top-1/2 transform -translate-y-1/2 pointer-events-none">
          <svg className="w-3 h-3 fill-current text-gray-600" viewBox="0 0 20 20">
