...
const TextWithContactButton = ({ title, subtitle, textContent, imgSrc }) => {
  return (
    <div className="flex flex-col sm:flex-row justify-between max-w-7xl mx-auto px-4 sm:px-6 items-center my-20 w-full text-center sm:text-left">
      <div className="max-w-lg sm:w-1/2">
        ...
        />
        <p className="text-lg mb-4 text-black mt-5 sm:mt-0">{textContent}</p>
